...
new #[Title('Edit Purchase')] class extends Component
{
    ...
    {
        $this->purchase = $purchase->load('purchaseItems');
        ...
        $this->items = $purchase->purchaseItems
            ->map(function ($item) {
...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500">
            Update supplier, employee or purchase items.
        </p>
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-12">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div class="mt-1 flex h-10 items-center rounded-lg bg-gray-50 px-3 font-semibold">
                                            {{ number_format($this->itemTotal($index), 2) }}
                                        </div>
                                    ...
                                    <div class="md:col-span-1 flex items-end">
                                        ...
                                        @if(count($items) > 1)
                                            ...
                                            <button
                                                ...
                                                class="w-full rounded-lg bg-red-100 px-3 py-2 text-sm font-medium text-red-700"
                                            >
                                                Remove
                                            </button>
