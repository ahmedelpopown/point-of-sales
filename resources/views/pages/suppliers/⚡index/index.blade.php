<div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold text-gray-900">supplier</h1>
            <p class="mt-2 text-sm text-gray-700">
                A list of all supplier including their name, email, cities, and address.
            </p>
        </div>
    ...
    <div class="mt-4 bg-indigo-50 p-4 rounded-md flex items-center justify-between">
        <span class="text-sm text-indigo-700">
            {{ count($selected) }} supplier(s) selected
        </span>
        <div class="flex gap-2">
            ...
            <button wire:click="bulkDelete" wire:confirm="Are you sure you want to delete the selected suppliers?"
    ...
    Status
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            ...
                            <tr wire:key="supplier-{{ $supplier->id }}" class="hover:bg-gray-50">
                                ...
                                @php
    $totalPurchases = (float) ($supplier->purchases_sum_total_price ?? 0);
    $paidAmount = (float) ($supplier->payments_sum_amount ?? 0);
    $debtAmount = max($totalPurchases - $paidAmount, 0);
@endphp
...
<td class="whitespace-nowrap px-3 py-4 text-sm font-semibold
    {{ $debtAmount > 0 ? 'text-red-600' : 'text-green-600' }}">
    {{ number_format($debtAmount, 2) }}
</td>

<td class="whitespace-nowrap px-3 py-4 text-sm">
    @if ($debtAmount <= 0)
        <span
            class="inline-flex items-center rounded-full bg-green-100 px-2.5 py-1
    ...
    @else
        <span
            class="inline-flex items-center rounded-full bg-red-100 px-2.5 py-1
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                        <button wire:click="deleteSupplier" type="button"
