    ...
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">
                A list of all product including their name, email, cities, and gender.
            </p>
        </div>
    ...
    @if(count($selected) > 0)
        <div class="mt-4 bg-indigo-50 p-4 rounded-md flex items-center justify-between">
            <span class="text-sm text-indigo-700">
                {{ count($selected) }} product(s) selected
            </span>
            <div class="flex gap-2">
                ...
                <button wire:click="bulkDelete" wire:confirm="Are you sure you want to delete the selected products?"
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th wire:click="sortBy('current_quantity')"
                                    class="cursor-pointer px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                                    <div class="flex items-center gap-2">
                                        Quantity
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm">
                                        <span
                                            class="inline-flex rounded-full px-2 text-xs font-semibold leading-5 
                                                            {{ $product->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-red-500' }}">
